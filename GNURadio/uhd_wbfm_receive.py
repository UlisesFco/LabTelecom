...
# Generated: Fri Sep  7 12:26:27 2018
##################################################
...
class uhd_wbfm_receive(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, address="addr=192.168.10.2", audio_output="", freq=93.3e6, gain=0, samp_rate=400e3):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate, 113000, 30e3, firdes.WIN_HANN, 6.76))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 113000, 30e3, firdes.WIN_HANN, 6.76))
